...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		el=me._ftt=document.createElement('div');
		els=me._ftt__text=document.createElement('div');
		...
		me._ftt.ggUpdateText();
		player.addListener('activehotspotchanged', function() {
			me._ftt.ggUpdateText();
		});
		el.appendChild(els);
		me._ftt.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._ftt.logicBlock_visible = function() {
			var newLogicStateVisible;
			if (
				((me.elementMouseOver['ftt'] == true)) && 
			...
			if (me._ftt.ggCurrentLogicStateVisible != newLogicStateVisible) {
				me._ftt.ggCurrentLogicStateVisible = newLogicStateVisible;
				me._ftt.style[domTransition]='';
				if (me._ftt.ggCurrentLogicStateVisible == 0) {
					me._ftt.style.visibility=(Number(me._ftt.style.opacity)>0||!me._ftt.style.opacity)?'inherit':'hidden';
					me._ftt.ggVisible=true;
				}
				else {
					me._ftt.style.visibility="hidden";
					me._ftt.ggVisible=false;
				}
			}
		}
		me._ftt.onmouseover=function (e) {
			me.elementMouseOver['ftt']=true;
			me._ftt.logicBlock_visible();
		}
		me._ftt.onmouseout=function (e) {
			if (e && e.toElement) {
				var current = e.toElement;
				while (current = current.parentNode) {
				if (current == me._ftt__text)
					return;
				}
			}
			me.elementMouseOver['ftt']=false;
			me._ftt.logicBlock_visible();
		}
		me._ftt.ontouchend=function (e) {
			me.elementMouseOver['ftt']=false;
			me._ftt.logicBlock_visible();
		}
		me._ftt.ggUpdatePosition=function (useTransition) {
			this.style[domTransition]='left 0';
			this.ggTextDiv.style.left=((102-this.ggTextDiv.offsetWidth)/2) + 'px';
		}
		me.divSkin.appendChild(me._ftt);
		...
		hs='data:image/svg+xml;base64,'+
		...
		el=me._open_web=document.createElement('div');
		el.ggId="open Web";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._open_web.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._open_web.onclick=function (e) {
			if (
				(
				...
				me._web_page.ggText="<iframe src=\""+player.hotspot.description+"\" width=\"100%\" height=\"100%\" allowfullscreen=\"true\" mozallowfullscreen=\"true\" webkitallowfullscreen=\"true\" frameborder= \"0\"><\/iframe>";
				me._web_page.ggTextDiv.innerHTML=me._web_page.ggText;
				if (me._web_page.ggUpdateText) {
					me._web_page.ggUpdateText=function() {
						var hs="<iframe src=\""+player.hotspot.description+"\" width=\"100%\" height=\"100%\" allowfullscreen=\"true\" mozallowfullscreen=\"true\" webkitallowfullscreen=\"true\" frameborder= \"0\"><\/iframe>";
						if (hs!=this.ggText) {
							this.ggText=hs;
							this.ggTextDiv.innerHTML=hs;
							if (this.ggUpdatePosition) this.ggUpdatePosition();
			...
			if (
				...
				player.openUrl(player.hotspot.description,player.hotspot.target);
			}
		}
		me._open_web.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._open_web);
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			''+
			'';
		...
		el=me._image_popup_control=document.createElement('div');
		el.ggId="image_popup_control";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._image_popup_control.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._image_popup_control.onclick=function (e) {
			me._popup_image.ggText=player.getBasePath()+""+player.hotspot.description;
		...
		me._image_popup_control.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._image_popup_control);
		...
		el=me._popupyt_video=document.createElement('div');
		el.ggId="popupYT_video";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		el.ggType='container';
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._popupyt_video.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._popupyt_video.onclick=function (e) {
			me._popup_video_youtube.ggInitMedia(player.hotspot.description);
			player.setVariableValue('vis_video_youtube', true);
		}
		me._popupyt_video.ggUpdatePosition=function (useTransition) {
		}
		me.divSkin.appendChild(me._popupyt_video);
		el=me._slidout=document.createElement('div');
		el.ggId="SlidOut";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_rectangle ";
		...
		me._slidout.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((me.elementMouseOver['slidout'] == true))
			)
			{
			...
			if (me._slidout.ggCurrentLogicStatePosition != newLogicStatePosition) {
				me._slidout.ggCurrentLogicStatePosition = newLogicStatePosition;
				me._slidout.style[domTransition]='left 500ms ease 0ms, top 500ms ease 0ms';
				if (me._slidout.ggCurrentLogicStatePosition == 0) {
					me._slidout.style.left='10px';
		...
		me._slidout.onmouseover=function (e) {
			me._text_1.ggText=player.hotspot.description;
			...
			if (me._text_1.ggUpdatePosition) {
				me._text_1.ggUpdatePosition();
			}
			me._text_1.ggTextDiv.scrollTop = 0;
			me.elementMouseOver['slidout']=true;
			me._slidout.logicBlock_position();
		}
		me._slidout.onmouseout=function (e) {
			me.elementMouseOver['slidout']=false;
			me._slidout.logicBlock_position();
		}
		me._slidout.ontouchend=function (e) {
			me.elementMouseOver['slidout']=false;
			me._slidout.logicBlock_position();
		}
		me._slidout.ggUpdatePosition=function (useTransition) {
		}
		...
		me._slidout.appendChild(me._text_1);
		me.divSkin.appendChild(me._slidout);
		el=me._rollover=document.createElement('div');
		el.ggId="RollOver";
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_container ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._rollover.ggIsActive=function() {
			return false;
		}
		el.ggElementNodeId=function() {
			return player.getCurrentNode();
		}
		me._rollover.onmouseover=function (e) {
			player.setMediaVisibility(player.hotspot.description,"1",500);
		}
		me._rollover.onmouseout=function (e) {
			player.setMediaVisibility(player.hotspot.description,"0",500);
		}
		me._rollover.ggUpdatePosition=function (useTransition) {
		}
		me._rollover.ggNodeChange=function () {
			player.setMediaVisibility("roll.*","0",0);
		}
		me.divSkin.appendChild(me._rollover);
		el=me._button_open_map=document.createElement('div');
		els=me._button_open_map__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
		...
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			''+
			''+
			''+
			'wzNzQuMS0xODUuMywzNjEuNC0xODUuMywzNjEuNHoiLz4KICAgPHBhdGggZmlsbD0iI0ZGRkZGRiIgZD0iTS0xNjAuOSw0MDUuMXYyOC4xbDE4LjktNS44YzAuOS0wLjMsMS42LTEuMywxLjYtMi4ydi0yNi43TC0xNjAuOSw0MDUuMXoiLz4KICA8L2c+CiA8L2c+Cjwvc3ZnPgo=';
		...
		me.divSkin.appendChild(me._button_open_map);
	...
	this.hotspotProxyClick=function(id, url) {
		if (id=='web') {
			me._open_web.onclick();
		}
		if (id=='image') {
			me._image_popup_control.onclick();
		}
		if (id=='yt') {
			me._popupyt_video.onclick();
		}
	}
	...
	me.hotspotProxyOver=function(id, url) {
		me._ftt.onmouseover();
		me._slidout.onmouseover();
		if (id=='roll') {
			me._rollover.onmouseover();
		}
	}
	me.hotspotProxyOut=function(id, url) {
		me._ftt.onmouseout();
		me._slidout.onmouseout();
		if (id=='roll') {
			me._rollover.onmouseout();
		}
	}
	...
	me.skinTimerEvent=function() {
		...
		var hs='';
		if (me._ftt.ggParameter) {
			hs+=parameterToTransform(me._ftt.ggParameter) + ' ';
		}
		hs+='translate(' + (1 * player.mouse.x + 0) + 'px,0px) ';
		hs+='translate(0px,' + (1 * player.mouse.y + 0) + 'px) ';
		me._ftt.style[domTransform]=hs;
	...
	player.addListener('changenode', function(args) { me._ftt.logicBlock_visible();me._screen_tint_url.logicBlock_visible();me._web_page.logicBlock_visible();me._close_url.logicBlock_visible();me._screentint_image.logicBlock_visible();me._image_popup.logicBlock_visible();me._popup_image.logicBlock_visible();me._image_popup_close.logicBlock_visible();me._video_screentint_youtube.logicBlock_visible();me._video_popup_youtube.logicBlock_visible();me._popup_video_youtube.logicBlock_visible();me._video_popup_close_youtube.logicBlock_visible(); });
	player.addListener('activehotspotchanged', function(args) { me._ftt.logicBlock_visible(); });
